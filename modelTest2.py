...
async def create_diary(entry: DiaryEntry):
    try:
        ...
        translated_crop = translator.translate(entry.crop, dest='en').text
        ...
        # Replace with translated values
        entry.crop = translated_crop
        entry.weather = translated_weather
        entry.issues = translated_issues
        entry.work = translated_work
